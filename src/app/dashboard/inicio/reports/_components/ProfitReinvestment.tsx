  ...
  return (
    <div style={{
      ...
      <h3 style={{
        ...
        fontSize: "0.85rem", fontWeight: 700, color: "#2d3748", margin: "0 0 4px 0",
      }}>
        Ganancias y Administración
      </h3>
      <p style={{
        fontFamily: "var(--font-poppins)",
        fontSize: "0.65rem", color: "#708090", margin: "0 0 20px 0",
      }}>
      ...
      <div style={{ marginBottom: 20 }}>
        <p style={{ fontFamily: "var(--font-marcellus)", fontSize: "0.7rem", color: "#708090", margin: "0 0 4px 0", fontWeight: 600 }}>
          Ingresos Brutos
        </p>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, flex: 1 }}>
        ...
        <div>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
            <span style={{ fontFamily: "var(--font-marcellus)", fontSize: "0.7rem", color: "#2d3748", fontWeight: 600 }}>Costo de Mercancía</span>
            <span style={{ fontFamily: "var(--font-poppins)", fontSize: "0.7rem", color: "#2d3748", fontWeight: 700 }}>{fmt(estimatedCost)}</span>
          </div>
          <div style={{ width: "100%", background: "#f6f4ef", borderRadius: 4, height: 6 }}>
            <div style={{ width: `${(estimatedCost/ingresos)*100 || 0}%`, background: "#708090", borderRadius: 4, height: "100%" }} />
          </div>
        </div>

        <div>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 6 }}>
            <span style={{ fontFamily: "var(--font-marcellus)", fontSize: "0.7rem", color: "#2d3748", fontWeight: 600 }}>Ganancia Antes de Adm.</span>
      ...
      <div style={{ 
        ...
        <h4 style={{ fontFamily: "var(--font-marcellus)", fontSize: "0.7rem", color: "#2d3748", fontWeight: 700, margin: "0 0 10px 0" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", marginBottom: 8, alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            ...
            <span style={{ fontFamily: "var(--font-marcellus)", fontSize: "0.7rem", color: "#2d3748" }}>Reinversión (25%)</span>
          </div>
          <span style={{ fontFamily: "var(--font-poppins)", fontSize: "0.75rem", fontWeight: 700, color: "#2d3748" }}>{fmt(fondoInversion)}</span>
        </div>
        
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ width: 8, height: 8, borderRadius: "50%", background: "#B76E79" }} />
            <span style={{ fontFamily: "var(--font-marcellus)", fontSize: "0.7rem", color: "#2d3748" }}>Ganancia Neta (70%)</span>
          </div>
          <span style={{ fontFamily: "var(--font-poppins)", fontSize: "0.75rem", fontWeight: 700, color: "#2d3748" }}>{fmt(gananciaNeta)}</span>
        </div>
      </div>
