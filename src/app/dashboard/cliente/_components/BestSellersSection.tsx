      ...
      >
        ...
        <div
          style={{
            height: 1,
            background:
              "linear-gradient(90deg, rgba(183,110,121,0.25), rgba(140,151,104,0.15), transparent)",
          ...
          >
            {productos.map((p, i) => (
              <motion.div
                ...
                whileHover={{
                  y: -8,
                  boxShadow: "0 24px 56px rgba(183,110,121,0.15)",
                }}
              ...
              >
                ...
                {i < 3 && (
                  ...
                  >
                    <Star size={9} fill="white" color="white" />#{i + 1}
                  </div>
                )}
                ...
                <div
                  style={{
                    ...
                    position: "relative",
                    background:
                      "linear-gradient(135deg, #ede8e1 0%, #e2d9ce 100%)",
                    overflow: "hidden",
                  }}
                >
                  {p.url_imagen ? (
                  ...
                  <div
                    style={{
                      ...
                      inset: 0,
                      background:
                        "linear-gradient(to top, rgba(74,85,104,0.5) 0%, transparent 60%)",
                      opacity: 0,
