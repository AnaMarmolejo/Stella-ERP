...
export default function AlternatingCollections() {
  ...
  const col1 = productos
    .filter(p => (p.tipo || "").toLowerCase().includes("anillo"))
    .slice(0, 2);
  const col2 = productos
    .filter(p => !(p.tipo || "").toLowerCase().includes("anillo"))
    .slice(0, 2);
  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginBottom: 60 }}>
        ...
        >
          Nuestras{" "}
          <em style={{ color: "#b76e79", fontStyle: "italic" }}>Colecciones</em>
        </h2>
      </div>
              ...
              >
                <div
                  style={{
                    position: "absolute",
                    inset: 0,
                    background: "rgba(107,76,50,0.05)",
                    display: "flex",
                    flexDirection: "column",
                    alignItems: "center",
