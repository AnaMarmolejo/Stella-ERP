...
const C = {
  ...
  sageLg:
    "0 30px 60px rgba(140,151,104,0.18), 0 10px 20px rgba(0,0,0,0.03), inset 0 0 0 1px rgba(255,255,255,0.5)",
};
    ...
    >
      ...
      <div
        style={{
          ...
          width: "35%",
          height: "35%",
          background: `radial-gradient(circle, ${C.slate} 0%, transparent 70%)`,
          opacity: 0.03,
          filter: "blur(80px)",
        }}
      />
      ...
      <div
        style={{
          ...
          width: "45%",
          height: "45%",
          background: `radial-gradient(circle, ${C.slateDeep} 0%, transparent 70%)`,
          opacity: 0.04,
          filter: "blur(120px)",
        }}
      />
  ...
  return (
    ...
    >
      ...
      <h3
        style={{
          fontFamily: "var(--font-subtitle)",
          fontSize: "clamp(1.25rem,1.9vw,1.52rem)",
          fontWeight: 600,
          color: C.slateDeep,
          marginBottom: 10,
          letterSpacing: "-0.01em",
    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          width: 3,
          background: `linear-gradient(180deg, ${C.slate} 0%, transparent 100%)`,
      ...
      >
        <div
          style={{
            ...
            borderRadius: "50%",
            flexShrink: 0,
            background: `linear-gradient(135deg, ${C.slateIcon}, rgba(140,151,104,0.12))`,
            border: `1px solid ${C.slateBorder}`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
        ...
        <div>
          <div
            style={{ fontSize: "0.88rem", fontWeight: 500, color: C.slateDeep }}
          >
            {name}
          </div>
          <div
...
const showcaseImages = [
  {
    src: "/video/capturas/01_dashboard_desktop.png",
    type: "desktop",
    label: "Dashboard Central",
  },
  {
    src: "/video/capturas/04_bom_desktop.png",
    type: "desktop",
    label: "Ingeniería BOM",
  },
  {
    src: "/video/capturas/03_consignaciones_tablet.png",
    type: "tablet",
    label: "Consignaciones",
  },
  {
    src: "/video/capturas/02_campanas_desktop.png",
    type: "desktop",
    label: "Marketing",
  },
  {
    src: "/video/capturas/05_rol_admin_mobile.png",
    type: "mobile",
    label: "Admin Móvil",
  },
  {
    src: "/video/capturas/05_rol_cliente_mobile.png",
    type: "mobile",
    label: "Filtros Probadores AR",
  },
  {
    src: "/video/capturas/05_rol_mayorista_mobile.png",
    type: "mobile",
        ...
        >
          ...
          <div
            style={{
              ...
              border:
                current.type === "mobile"
                  ? `10px solid ${C.slateDeep}`
                  : `1px solid ${C.slateBorder}`,
          ...
          >
            ...
            <div
              style={{
                ...
                inset: 0,
                background:
                  "linear-gradient(120deg, rgba(255,255,255,0.08) 0%, transparent 50%, rgba(255,255,255,0.03) 100%)",
                pointerEvents: "none",
                zIndex: 5,
              }}
            />
...
const features: FeatureCardProps[] = [
  {
    icon: <ShieldCheck size={20} color={C.slate} />,
    title: "Pagos Seguros",
    text: "Stripe y SPEI con cifrado AES y cumplimiento PCI-DSS en cada transacción.",
  },
  {
    icon: <Package size={20} color={C.slate} />,
    title: "Inventario en Tiempo Real",
    text: "Control FIFO/LIFO con alertas automáticas y notificaciones push al detectar stock bajo.",
  },
  {
    icon: <Sparkles size={20} color={C.slate} />,
    title: "Filtros Probadores en Tiempo Real",
    text: "Experiencia de realidad aumentada para que tus clientes prueben cada joya virtualmente antes de comprar.",
  },
  {
    icon: <Bot size={20} color={C.slate} />,
    title: "IA Generativa",
    text: "Análisis inteligente de información y generación automática de nombres y descripciones premium con Gemini API.",
  },
];
...
const roles: RoleCardProps[] = [
  {
    ...
    perks: [
      ...
      "Reportes y analítica predictiva",
  ...
  },
  {
    ...
    perks: [
      "Consignaciones trazables",
      "Precios y descuentos por volumen",
      "Reportes PDF/Excel individuales",
  ...
  },
  {
    ...
    perks: [
      "Filtros Probadores en Tiempo Real",
      "Reseñas y sistema de rating",
...
const modules: ModuleCardProps[] = [
  {
    num: "01",
    icon: <LayoutGrid size={18} color={C.slate} />,
    name: "Catálogo con Probadores",
    desc: "Artículos con filtros de realidad aumentada para prueba inmediata.",
  },
  {
    num: "02",
    icon: <Database size={18} color={C.slate} />,
    name: "Inventario Inteligente",
    desc: "WebSockets + triggers SQL para actualización automática.",
  },
  {
    num: "03",
    icon: <CircleDollarSign size={18} color={C.slate} />,
    name: "Gestión de Precios",
    desc: "Márgenes, descuentos por volumen y políticas de fidelización.",
  },
  {
    num: "04",
    icon: <ShoppingCart size={18} color={C.slate} />,
    name: "Pedidos y Ventas",
    desc: "Trazabilidad ACID, devoluciones y panel interactivo.",
  },
  {
    num: "05",
    icon: <TrendingUp size={18} color={C.slate} />,
    name: "Reportes Estratégicos",
    desc: "Dashboards con KPIs personalizables y analítica predictiva.",
  },
  {
    num: "06",
    icon: <Handshake size={18} color={C.slate} />,
    name: "Módulo Mayoristas",
    desc: "Consignaciones, créditos y paneles individualizados.",
  },
];
...
const reviews: ReviewCardProps[] = [
  {
    text: "La trazabilidad de consignaciones es exactamente lo que necesitábamos. Antes perdíamos piezas; ahora tenemos control total.",
    initials: "MR",
    name: "María R.",
    role: "Distribuidora Mayorista",
  },
  {
    text: "El dashboard en tiempo real me da la tranquilidad de saber qué piezas tengo disponibles desde cualquier dispositivo.",
    initials: "EB",
    name: "Estela B.",
    role: "Administradora · Stella",
  },
  {
    text: "Poder probarme las joyas con los filtros en tiempo real es increíble. Ver cómo luce la pieza antes de comprarla me da una seguridad absoluta.",
    initials: "LC",
    name: "Laura C.",
    ...
    <>
      ...
      <main
        style={{
          background: C.bg,
          color: C.slate,
          fontFamily: "var(--font-sans, 'Tan Mon Cheri', sans-serif)",
          overflowX: "hidden",
        }}
      >
        {/* ══════════ NAV ══════════ */}
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            <motion.button
              ...
              style={{
                ...
                letterSpacing: "0.04em",
                fontFamily: "var(--font-sans, Inter, sans-serif)",
                boxShadow: `0 3px 10px ${C.roseBorder}`,
                  ...
                  return (
                    <a
                      ...
                      style={{
                        ...
                        padding: "16px 24px",
                        background: isActive
                          ? "linear-gradient(90deg, rgba(183,110,121,0.06) 0%, transparent 100%)"
                          : "transparent",
                        borderLeft: isActive
                          ? `3px solid ${C.rose}`
                    ...
                    >
                      ...
                      {isActive && (
                        <motion.span
                          ...
                          style={{ fontSize: "1rem", color: C.rose }}
                        >
                          ✦
                        </motion.span>
                      )}
          ...
          >
            ...
            >
              ...
              <motion.div initial="hidden" animate="show" variants={containerV}>
                ...
                >
                  Gestión{" "}
                  <span style={{ color: C.rose, fontStyle: "italic" }}>
                    Maestra
                  </span>{" "}
                  para Joyería.
                </motion.h1>
                ...
                >
                  Stella ERP centraliza tu producción, inventarios y ventas con
                  una interfaz diseñada para la excelencia y el control absoluto
                  del negocio artesanal.
                </motion.p>
                ...
                >
                  <motion.button
                    whileHover={{
                      scale: 1.02,
                      boxShadow: `0 8px 25px ${C.roseBorder}`,
                    }}
                    whileTap={{ scale: 0.97 }}
                    ...
                    style={{
                      ...
                      letterSpacing: "0.04em",
                      fontFamily: "var(--font-subtitle)",
                      boxShadow: `0 4px 15px ${C.roseBorder}`,
                      display: "flex",
                      alignItems: "center",
                      gap: 10,
                    }}
                ...
                >
                  {[
                    { num: "50%", label: "Menos errores" },
                    { num: "3", label: "Roles clave" },
                    { num: "10+", label: "Módulos ERP" },
                  ].map((s, i) => (
                    <div
                      key={s.label}
                      style={{
          ...
          <div style={{ maxWidth: 1240, margin: "0 auto" }}>
            ...
            >
              <SectionHeader
                ...
                accent="diferente"
                after="a Stella"
                sub="Cada funcionalidad diseñada para resolver un problema real de la joyería artesanal."
              />
              <div
                className="feat-grid"
                style={{
        ...
        <div
          style={{
            height: 1,
            background: `linear-gradient(90deg,transparent,${C.slateMid},transparent)`,
            maxWidth: 1200,
            margin: "0 auto",
          }}
        />
        ...
        <section id="usuarios" style={{ padding: SP, background: C.bg }}>
          <div style={{ maxWidth: 1240, margin: "0 auto" }}>
            ...
            >
              <SectionHeader
                before="Una plataforma para"
                accent="cada rol"
                sub="Accesos, vistas y herramientas diseñadas para el administrador, distribuidor y comprador."
              />
              <div
          ...
          <div style={{ maxWidth: 1240, margin: "0 auto" }}>
            ...
            >
              <SectionHeader
                before="Módulos"
                accent="funcionales"
                sub="Independientes y escalables — activa solo lo que tu negocio necesita."
              />
              <div
                className="mod-grid"
                style={{
        ...
        <section
          style={{
            padding: `clamp(40px,5vw,60px) clamp(20px,5vw,52px)`,
            background: "#4a5568",
            position: "relative",
            overflow: "hidden",
          }}
        >
          <div
            style={{
              position: "absolute",
              inset: 0,
              backgroundImage: `radial-gradient(circle, rgba(246,244,239,0.05) 1px, transparent 1px)`,
        ...
        <section id="tecnologia" style={{ padding: SP, background: C.bg }}>
          <div style={{ maxWidth: 1240, margin: "0 auto" }}>
            ...
            >
              <SectionHeader
                before="Construido con"
                accent="tecnología de vanguardia"
              />
              <motion.div
                variants={containerV}
                style={{
          ...
          <div style={{ maxWidth: 1240, margin: "0 auto" }}>
            ...
            >
              <SectionHeader
                ...
                sub="Escuchamos cada palabra de quienes confían en nosotros para sus momentos inolvidables."
              />
              <div
                className="rev-grid"
                style={{
        ...
        <section
          id="contacto"
          style={{
            padding: `clamp(36px,4.5vw,52px) clamp(20px,5vw,52px)`,
            background: "#4a5568",
            position: "relative",
            overflow: "hidden",
          }}
          ...
          >
            ...
            >
              ...
              <div style={{ flex: 1, minWidth: 260 }}>
                ...
                >
                  Explora nuestro catálogo y encuentra esa pieza que hablará por
                  ti más allá de una sola palabra.
                </motion.p>
              </div>
            </div>
          </motion.div>
        ...
        <footer
          style={{
            padding: "clamp(16px,2vw,22px) clamp(20px,5vw,52px)",
            background: "#3d4a5c",
            borderTop: `1px solid rgba(246,244,239,0.07)`,
          }}
        >
          <div
